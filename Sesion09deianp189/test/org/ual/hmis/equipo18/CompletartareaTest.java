...
import java.net.URL;
public class CompletartareaTest {
  ...
  public void completartarea() {
    ...
    // 3 | click | css=.row:nth-child(5) .btn-primary | 
    driver.findElement(By.cssSelector(".row:nth-child(5) .btn-primary")).click();
  }
}
